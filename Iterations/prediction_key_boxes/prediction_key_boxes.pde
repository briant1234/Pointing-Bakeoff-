...
int nextTrialNum = 1; // next trial number
...
void keyPressed() // test to see if hit was in target!
{
...
void drawButton(int i)
{
  ...
  stroke(#696969);
  fill(0, 0, 0);
  rect(bounds.x-buffer, bounds.y-buffer, bounds.width+padding, bounds.height+padding); //draw margin boxes
  noStroke();
  ...
  rect(bounds.x, bounds.y, bounds.width, bounds.height); // draw boxes
}
